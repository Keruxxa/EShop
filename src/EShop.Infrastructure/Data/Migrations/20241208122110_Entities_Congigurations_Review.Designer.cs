...
namespace EShop.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241208122110_Entities_Congigurations_Review")]
    partial class Entities_Congigurations_Review
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EShop.Domain.Entities.CategoryClosureNode", b =>
                {
                    b.Property<int>("AncestorCategoryId")
                        .HasColumnType("integer");

                    b.Property<int>("DescendantCategoryId")
                        .HasColumnType("integer");

                    b.HasKey("AncestorCategoryId", "DescendantCategoryId");

                    b.HasIndex("DescendantCategoryId");

                    b.ToTable("CategoryClosureNodes", (string)null);
                });
            ...
            modelBuilder.Entity("EShop.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<int>("OrderDeliveryStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1);
                    ...
                    b.HasIndex("OrderDeliveryStatusId");
            ...
            modelBuilder.Entity("EShop.Domain.Entities.OrderDeliveryStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("OrderDeliveryStatuses");
            ...
            modelBuilder.Entity("EShop.Domain.Entities.CategoryClosureNode", b =>
                {
                    b.HasOne("EShop.Domain.Entities.Category", "AncestorCategory")
                        .WithMany()
                    ...
                    b.HasOne("EShop.Domain.Entities.Category", null)
                        .WithMany()
                        .HasForeignKey("DescendantCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EShop.Domain.Entities.Order", b =>
                {
                    b.HasOne("EShop.Domain.Entities.OrderDeliveryStatus", "OrderDeliveryStatus")
                        .WithMany()
                        .HasForeignKey("OrderDeliveryStatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
