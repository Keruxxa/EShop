This is my pet-project in which I'm actually learning `ASP.NET Core` and some others technologies like `Docker`, `Kafka` and `Redis`. Code base increases and changes as I explore and study programming using `C#`
